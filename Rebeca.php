                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="Rebeca.php">All classes</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="page-scroll" href="payment.php">Pagamento</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div class="container">
                        ...
                        <table class="table table-bordered table-hover" style="background-color: white;">
                            ...
                            <tbody>
                                ...
                                <td><a class="more" href="quiz.php"><img src="https://i.ibb.co/mRPQZjx/iconfinder-document03-1622833-121957.png" alt="quiz" height="25px" width="25px"></a>&nbsp;&nbsp;<a class="more" href="video.php"><img src="https://i.ibb.co/v4bzb7F/botao-play.png" alt="video" height="25px" width="25px"></a></td>
                                </tr>
                                <tr>
                                <th>02/01</th>
                                <td>Past Continuous</td>
                                <td><a class="more" href="assets/classes/When-bad-means-good.pdf"><img src="https://i.ibb.co/3swb9h8/file-type-pdf-icon-130274.png" alt="pdf" height="25px" width="25px"></a></td>
                                <td><a class="more" href="quiz.php"><img src="https://i.ibb.co/mRPQZjx/iconfinder-document03-1622833-121957.png" alt="quiz" height="25px" width="25px"></a>&nbsp;&nbsp;<a class="more" href="video.php"><img src="https://i.ibb.co/v4bzb7F/botao-play.png" alt="video" height="25px" width="25px"></td>
                                </tr>
                                <th>03/01</th>
                                <td>Past Perfect</td>
                                <td><a class="more" href="assets/classes/When-bad-means-good.pdf"><img src="https://i.ibb.co/3swb9h8/file-type-pdf-icon-130274.png" alt="pdf" height="25px" width="25px"></a></td>
                ...
                <div class="col-lg-6">
                    <div class="about-content mt-50 wow fadeInLeftBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="section-title">
                            <div class="line"></div>
                            <h3 class="title">Exercícios Extras. <span> Pratique fora de sala.</span></h3>
                        </div> 
                        <p class="text">Fazer exercícios extras te ajudam a gravar melhor o conteúdo aprendido durante a aula.</p>
                        <a href="#" class="main-btn">Exercícios</a>
                    </div> 
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="counter-wrapper mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="counter-content">
                            <div class="section-title">
                                <div class="line"></div>
                                <h3 class="title">Vídeo Aulas <br><span> Assista explicações em vídeo.</span></h3>
                            </div> 
                            <p class="text">Assista aulas a qualquer momento e revise o conteúdo aprendido em sala.</p>
                            <br>
                            <a href="#" class="main-btn">Vídeos</a>
                        </div> 
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-35">
                        <div class="line"></div>
                        <h3 class="title"><span>Mensalidade <br></span> Download do Boleto, ou dados para PIX</h3>
                    </div> 
                </div>
            </div> 
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <div class="blog-content">
                            <ul class="meta">
                                <li>Vencimento: <a href="#">Admin</a></li>
                                <li>03 June, 2023</li>
                            </ul>
                            <p class="text">Dados para PIX &nbsp;&nbsp;&nbsp;<span style="font-weight:bolder; font-style:italic; font-size:small; color:blue">CNPJ - 37.436.667/0001-41</span></p>
                            <a class="more" href="#">Download do Boleto<i class="lni-chevron-right"></i></a>
                        </div>
                    </div>  
                </div> ======-->
                <!--====== <div class="col-lg-4 col-md-7">
