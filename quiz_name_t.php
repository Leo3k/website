  ...
  <![endif]-->    
    ...
    <header class="header-area">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item">
                                        <a class="page-scroll" href="tamires_pay.php">Payment</a>
                                    </li>
                                    <li class="nav-item">
        ...
        <div class="container">
                        ...
                        <iframe scrolling="no" src="https://www.quiz-maker.com/QE52VQU64" width="98%" height="600vw" style="border:1px solid black;">
            </iframe>
            <p> Não abriu? Então, é só clicar <a href="https://www.quiz-maker.com/QE52VQU64" target="_blank">AQUI</a>
        </div>
