                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ml-auto">
                                    <li class="nav-item active">
                                        <a class="page-scroll" href="allan.php">Home</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="navbar-btn d-none d-sm-inline-block">
                               <p><a class="main-btn" data-scroll-nav="0" href="allan.php"><?php echo $_SESSION['usuario']; ?></a></p>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
        ...
        <div class="container">
                        ...
                        <table class="table table-bordered table-hover" style="background-color: white;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                <th>29/06</th>
                                <td>Present Perfect PART 2</td>
                                <td><a class="more" href="https://docs.google.com/document/d/1Cf3L5Iq-yyhMTw5d_h_BnQNz0zMXF9aoO8HvpSm5OaY/edit?usp=sharing">&#128196;</a></td>
                                <td></td>
                                </tr> 
                                <tr>
                                <th>18/07</th>
                                <td>Present Perfect vs. Simple Past</td>
                                <td></td>
                                <td></td>
                                </tr>
                                <tr>
